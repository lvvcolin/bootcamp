...
<div class="w-full relative mt-4 shadow-2xl rounded my-24 overflow-hidden">
    ...
    <div class="top h-64 w-full bg-blue-600 overflow-hidden relative">
        ...
        <div class="flex flex-col justify-center items-center relative h-full bg-black bg-opacity-50 text-white">
            ...
            <h4 class="text-sm font-semibold">Joined Since {{date('d-m-Y', strtotime($user->created_at)) }}</h4>
    ...
    <div class="grid grid-cols-12 bg-white ">
        ...
        <div
            ...
            <a href="{{ route('profile_edit', [$user]) }}"
                class="text-sm p-2 bg-indigo-200 text-center rounded font-semibold hover:bg-indigo-700 hover:text-gray-200">Update
                Information</a>
            ...
            <div class="px-4 pt-4">
                ...
                <form action="#" class="flex flex-col space-y-8">
                    ...
                    <div>
                        ...
                        <h3 class="text-2xl font-semibold">My Repo channels</h3>
                    ...
                    <div class="form-item">
                        ...
                        <label class="text-xl ">Azure</label>
                    ...
                    <div class="form-item">
                        ...
                        <label class="text-xl ">Gitlab</label>
                    ...
                    <div class="form-item">
                        ...
                        <label class="text-xl ">Github</label>
